 ...
 */
class StaffMembersRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, StaffMembers::class);
    }

    // /**
    //  * @return StaffMembers[] Returns an array of StaffMembers objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?StaffMembers
    {
        return $this->createQueryBuilder('m')
            ->andWhere('m.exampleField = :val')
            ->setParameter('val', $value)
